...
export default function Footer({ ApplicationName, ApplicationLogoDark, ApplicationLogoLight }) {
    ...
    return (
        <footer className="mt-10 bg-white border-t border-gray-200 dark:border-gray-800 dark:bg-gray-800">
            <div className="px-6 py-10 mx-auto max-w-7xl lg:px-8">
                ...
                {/* Bottom Bar */}
                <div className="pt-8 mt-8 border-t border-gray-200 dark:border-gray-600">
