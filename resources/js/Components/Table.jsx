                                                ...
                                                >
                                                    ...
                                                    {openDropdownId === item.id &&
                                                        createPortal(
                                                            ...
                                                            >
                                                                <ul
                                                                    className="scrollbar-thin dark:scrollbar-thumb-white scrollbar-thumb-blue-500 scrollbar-track-transparent overflow-y-scroll py-1 text-sm text-gray-700 dark:text-gray-200"
